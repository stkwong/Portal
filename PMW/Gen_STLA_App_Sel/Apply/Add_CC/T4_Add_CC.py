...
class T4_Add_CC_Form(QDialog):
    ...
    def __init__(self, path, p_to_database, p_to_documents, p_to_server):
        ...
        loadUi(path + r"\PMW\Gen_STLA_App_Sel\Apply\Add_CC\T4_Add_CC.ui",self)
        ...
        self.T4_Add_CC_return_but.clicked.connect(self.toApply)
        self.T4_Add_CC_reload_but.clicked.connect(self.load_cc_recipient)
        self.T4_Add_CC_execute_but.clicked.connect(self.cc_execute)
        self.T4_Add_CC_n_a_rad.setChecked(True)

        self.isDirectClose = True
        self.save = False

        self.T4_Add_CC_recipient_com.currentTextChanged.connect(self.showrest)
    ...
    def showrest(self):
        ...
        self.load_cc_attention()
        self.load_cc_fax()
        self.enable_rad()

    def load_cc_recipient(self):
        self.reset()
        self.T4_Add_CC_recipient_com.clear()
        self.T4_Add_CC_recipient_com.addItem("")
